...
\draw[decorate, decoration={brace, mirror, amplitude=5pt},] ([yshift=-0.75cm]2.center)--([yshift=-0.75cm]4.center) node[pos=0.5, below=0.2cm]{$k-1$ états};
\end{tikzpicture}
